...
The Gentarium Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Gentarium Core project, and is not to be
confused with overall Gentarium Network Protocol consensus changes.

Whether a pull request is merged into Gentarium Core rests with the project merge
...
Patches that change Gentarium consensus rules are considerably more involved than
...
Where a patch set proposes to change the Gentarium consensus, it must have been
