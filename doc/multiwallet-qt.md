...
In order to support loading of multiple wallets in gentarium-qt, a few changes in the UI architecture will be needed.
...
----------------------
gentarium.cpp is the entry point into gentarium-qt, and as such, will require some minor modifications to provide hooks for
