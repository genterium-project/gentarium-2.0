...
This mechanism has been integrated into Bitcore-Node-Gentarium which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/gentarium-project/insight-api-gentarium#web-socket-api](https://github.com/gentarium-project/insight-api-gentarium#web-socket-api) 
* API: [https://github.com/gentarium-project/insight-api-gentarium#swifttx-transactions](https://github.com/gentarium-project/insight-api-gentarium#swifttx-transactions) 
