...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<gentarium_address\> \<monthly_payment_gentarium\> [use_ix(true|false)]
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<gentarium_address\> \<monthly_payment_gentarium\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` Gentarium.
