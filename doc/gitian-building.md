...
*Setup instructions for a gitian build of Gentarium using a Debian VM or physical system.*
...
- [Building Gentarium](#building-gentarium)
...
Clone the git repositories for gentarium and gitian and then checkout the gentarium version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/gentarium-crypto/gentarium.git
cd gentarium
...
Follow the instructions in [doc/release-process.md](release-process.md) in the gentarium repository
...
To build Gentarium (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the gentarium repository.
...
```bash
    ...
    From https://github.com/gentarium-crypto/gentarium
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/gentarium-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/gentarium-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/gentarium-build.assert
```
...
[gentarium/gitian.sigs](https://github.com/gentarium-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
