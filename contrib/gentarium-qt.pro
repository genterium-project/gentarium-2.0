...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/gentarium-cli.cpp \
           src/gentarium-tx.cpp \
           src/gentarium.cpp \
           src/db.cpp \
           ...
           src/qt/gentarium.cpp \
           src/qt/gentariumstrings.cpp \
...
RESOURCES += src/qt/gentarium.qrc src/qt/gentarium_locale.qrc

TRANSLATIONS += src/qt/locale/gentarium_bg.ts \
                src/qt/locale/gentarium_de.ts \
                src/qt/locale/gentarium_en.ts \
                src/qt/locale/gentarium_es.ts \
                src/qt/locale/gentarium_fi.ts \
                src/qt/locale/gentarium_fr.ts \
                src/qt/locale/gentarium_it.ts \
                src/qt/locale/gentarium_ja.ts \
                src/qt/locale/gentarium_pl.ts \
                src/qt/locale/gentarium_pt.ts \
                src/qt/locale/gentarium_ru.ts \
                src/qt/locale/gentarium_sk.ts \
                src/qt/locale/gentarium_sv.ts \
                src/qt/locale/gentarium_vi.ts \
                src/qt/locale/gentarium_zh_CN.ts \
                src/qt/locale/gentarium_zh_TW.ts
