...
gentarium-project/gentarium repository.
...
Setup
---------
Configuring the github-merge tool for the Gentarium repository is done in the following way:

    git config githubmerge.repository gentarium-project/gentarium
...
A script to optimize png files in the Gentarium
