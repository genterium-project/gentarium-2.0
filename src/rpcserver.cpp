...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Gentarium server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Gentarium server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Gentarium features */
        {"gentarium", "masternode", &masternode, true, true, false},
        {"gentarium", "listmasternodes", &listmasternodes, true, true, false},
        {"gentarium", "getmasternodecount", &getmasternodecount, true, true, false},
        {"gentarium", "masternodeconnect", &masternodeconnect, true, true, false},
        {"gentarium", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"gentarium", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"gentarium", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"gentarium", "masternodecurrent", &masternodecurrent, true, true, false},
        {"gentarium", "masternodedebug", &masternodedebug, true, true, false},
        {"gentarium", "startmasternode", &startmasternode, true, true, false},
        {"gentarium", "createmasternodekey", &createmasternodekey, true, true, false},
        {"gentarium", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"gentarium", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"gentarium", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"gentarium", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"gentarium", "getmasternodescores", &getmasternodescores, true, true, false},
        {"gentarium", "mnbudget", &mnbudget, true, true, false},
        {"gentarium", "preparebudget", &preparebudget, true, true, false},
        {"gentarium", "submitbudget", &submitbudget, true, true, false},
        {"gentarium", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"gentarium", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"gentarium", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"gentarium", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"gentarium", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"gentarium", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"gentarium", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"gentarium", "checkbudgets", &checkbudgets, true, true, false},
        {"gentarium", "mnsync", &mnsync, true, true, false},
        {"gentarium", "spork", &spork, true, true, false},
        {"gentarium", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzgtmseed", &getzgtmseed, false, false, true},
        {"zerocoin", "setzgtmseed", &setzgtmseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzgtm", &searchdzgtm, false, false, true},
        {"zerocoin", "dzgtmstate", &dzgtmstate, false, false, true}
