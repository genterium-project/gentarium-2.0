...
extern UniValue setzgtmseed(const UniValue& params, bool fHelp);
extern UniValue getzgtmseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzgtm(const UniValue& params, bool fHelp);
extern UniValue dzgtmstate(const UniValue& params, bool fHelp);
