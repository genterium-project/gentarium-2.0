                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_zGTM || context == Context::BIP_38) {
    ...
    // It doesn't make sense to show the checkbox for sending GTM because you wouldn't check it anyway.
    if (context == Context::Send_GTM || context == Context::Send_zGTM) {
            ...
            if (newpass1 == newpass2) {
                if (model->setWalletEncrypted(true, newpass1)) {
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                        "<qt>" +
                            tr("Gentarium will close now to finish the encryption process. "
                               "Remember that encrypting your wallet cannot fully protect "
                               "your GTMs from being stolen by malware infecting your computer.") +
                            "<br><br><b>" +
