...
// Copyright (c) 2015-2018 The Gentarium developers
                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzGTMPathCustom = GetArg("-zgtmbackuppath", "");
    ...
    if(!strzGTMPathCustom.empty()) {
        ui->wallet_customzgtmbackuppath->setText(QString::fromStdString(strzGTMPathCustom));
        ui->wallet_customzgtmbackuppath_label->setVisible(true);
        ui->wallet_customzgtmbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzGTMPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Gentarium RPC console.") + "<br>" +
