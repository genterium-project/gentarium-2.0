...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zGTM"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Gentarium Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Gentarium"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Gentaium Core help message to get a list with possible Gentarium command-line options"));
