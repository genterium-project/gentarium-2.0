...
#   c) node1 mines 32 blocks, so now node 0 has 60001gtm, node 1 has 4250gtm, node2 has none.
#   d) node0 sends 601 gtm to node2, in two transactions (301 gtm, then 300 gtm).
